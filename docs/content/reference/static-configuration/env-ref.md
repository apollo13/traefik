...
`TRAEFIK_PROVIDERS_CONSULCATALOG_CONNECTNATIVE`:  
Register and manage traefik in Consul Catalog as a Connect Native service. (Default: ```false```)
...
`TRAEFIK_PROVIDERS_CONSULCATALOG_SERVICEPORT`:  
